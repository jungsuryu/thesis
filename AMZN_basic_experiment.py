...
for thresh in gray_dict.keys():
    ...
    white_model = MF_base(R_white, K=220, alpha=0.0014, beta=0.003, iterations=400, tolerance=0.0005, verbose=True)
    ...
    gsu_model = MF_base(R_gray, K=220, alpha=0.0014, beta=0.003, iterations=400, tolerance=0.0005, verbose=True)
    ...
    # white sheep trained, black sheep tested
    weight_avg_gray_mf = (blk_bestseller * (black_pop/entire_pop)) + (white_rmse * ((rest_pop-len(gray_idx))/entire_pop)) + (gsu_mf_rmse * (len(gray_idx)/entire_pop))
    print(f'{thresh}% Gray Sheep MF weighted RMSE (w/ White Sheep): {weight_avg_gray_mf}')
    weighted_gray_mf[f'{thresh}'] = weight_avg_gray_mf

    # black sheep trained, black sheep tested
    blk_weight_avg_gray_mf = (blk_only_bestseller * (black_pop/entire_pop)) + (white_rmse * ((rest_pop-len(gray_idx))/entire_pop)) + (gsu_mf_rmse * (len(gray_idx)/entire_pop))
    print(f'{thresh}% Gray Sheep MF weighted RMSE (w/ Black Sheep): {blk_weight_avg_gray_mf}')
    blk_weighted_gray_mf[f'{thresh}'] = blk_weight_avg_gray_mf
...
with open('/home/ryu/thesis/real_amazon/basic_var/White_MF/8c_White MF.pkl', 'wb') as f:
    pickle.dump(white_mf, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Bestseller/8c_Bestseller.pkl', 'wb') as f:
    pickle.dump(bestseller, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Bestseller/8c_Weighted Bestseller.pkl', 'wb') as f:
    pickle.dump(weighted_bestseller, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Bestseller/8c_Weighted Bestseller Black.pkl', 'wb') as f:
    pickle.dump(blk_weighted_bestseller, f)
with open('/home/ryu/thesis/real_amazon/basic_var/GSU_Bestseller/8c_GSU Bestseller.pkl', 'wb') as f:
    pickle.dump(gray_bs, f)
with open('/home/ryu/thesis/real_amazon/basic_var/GSU_Bestseller/8c_Weighted GSU Bestseller.pkl', 'wb') as f:
    pickle.dump(weighted_gray_bs, f)
with open('/home/ryu/thesis/real_amazon/basic_var/GSU_Bestseller/8c_Weighted GSU Bestseller Black.pkl', 'wb') as f:
    pickle.dump(blk_weighted_gray_bs, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Gray_MF/8c_Gray MF.pkl', 'wb') as f:
    pickle.dump(gray_mf, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Gray_MF/8c_Weighted Gray MF.pkl', 'wb') as f:
    pickle.dump(weighted_gray_mf, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Gray_MF/8c_Weighted Gray MF Black.pkl', 'wb') as f:
    pickle.dump(blk_weighted_gray_mf, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Gray_NeuMF/8c_NeuMF.pkl', 'wb') as f:
    pickle.dump(neumf, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Gray_NeuMF/8c_Weighted NeuMF.pkl', 'wb') as f:
    pickle.dump(weighted_neumf, f)
with open('/home/ryu/thesis/real_amazon/basic_var/Gray_NeuMF/8c_Weighted NeuMF Black.pkl', 'wb') as f:
