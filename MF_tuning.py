...
# only_in_movies = movies['movie_id'].unique()
...
class MF_base():
    ...
    def set_test(self, ratings_test):
        ...
        for _, row in ratings_test.iterrows():
            ...
            item_idx = self.item_id_index.get(row['movie_id'], None)
    ...
    def fit(self, ratings, y=None):
        for params in ParameterGrid(self.param_grid):
            ...
            for i in range(self.cv):
                ...
                R_temp = ratings_train.pivot(index='user_id', columns='movie_id', values='rating').fillna(0)
...
param_grid = {
    'K': [220],
    'alpha': [0.001, 0.0012, 0.0014, 0.0016, 0.002, 0.0024, 0.0028],
    'beta': [0.075],
    'iterations': [400],
    'verbose': [True]
}
